...
namespace WIS.Tests
{
    ...
    /// <summary>
    ///Classe de test pour BackOfficeControllerTest, destinée à contenir tous
    ///les tests unitaires BackOfficeControllerTest
    ///</summary>
    [TestClass()]
    public class BackOfficeControllerTest
    {
        ...
        /// <summary>
        ///Test pour Constructeur BackOfficeController
        ///</summary>
        ...
        public void BackOfficeControllerConstructorTest()
        {
            BackOfficeController target = new BackOfficeController();
        ...
        {
            BackOfficeController target = new BackOfficeController(); // TODO: initialisez à une valeur appropriée
